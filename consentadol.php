...
$picf2 = "firmas/$documentor.png";
if(file_exists($picf2)){
$pdf->Image($picf2,115,180,70,'C');
}
else{
$pdf->Cell(10,10);	
}
...
$pdf->Cell(1,10);
$pdf->Cell(95,10,utf8_decode('____________________________'));
$pic2 = "huellas/$documentor.png";
if(file_exists($pic2)){
$pdf->Image($pic2,175,200,20,'C');
}
else{
$pdf->Cell(10,10);	
}
