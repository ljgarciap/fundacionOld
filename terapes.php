...
$result1=mysqli_query($con,"select agenda.fecha as fecha, agenda.hora as hora, agenda.encargado as encargado, agenda.estado as estado, agenda.idresidentes as idresidentes, residentes.nombresr as nombres, residentes.apellidosr as apellidos from agenda join residentes on agenda.idresidentes=residentes.idresidentes where agenda.encargado='ESPIRITUAL' order by hora asc;");
