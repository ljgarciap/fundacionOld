...
$resumen="Yo,  _____________________________________________________, identificado con cédula de ciudadanía número __________________ de _________________, actuando en mi calidad de representante legal del adolescente ________________________________________ con tarjeta de identidad número __________________ de _____________________ manifiesto mi aceptación del acompañamiento  psicosocial ofrecido por el  Psicólogo $psico de la Fundación Jesús es mi Roca, el cual me ha sido claramente explicado.
...
$pdf->Cell(30);
// Título
$pdf->Cell(0,15,utf8_decode('CONSENTIMIENTO INFORMADO ADOLESCENTE'));
// Salto de línea
$pdf->Ln(25);
