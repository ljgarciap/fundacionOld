...
?>
<center><img src="images/colpatria.png"></img></center>
<center><h2>Resumen Colpatria</h2></center>

<?php
$queryu="select * from colpatria order by fecha,idcolpatria asc;";	
...
?>
<tr>
<td><a href='editabanco.php?idt=<?php echo "$idcolpatria"; ?>'><?php echo "$fecha"; ?></a></td>
...
<center>
<div class="row">
<form id="movtienda" action = "movcolpatria.php" method = "get"> 
<div class="col-md-2">
<label>Fecha:</label>
