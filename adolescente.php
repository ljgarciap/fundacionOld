...
<center><h2>Listado de residentes adolescentes</h2></center>

<?php
$queryu="select residentes.idresidentes,residentes.nombresr,residentes.apellidosr,
residentes.documentor,residentes.expedicionr,residentes.tipodocumento,residentes.eps from residentes where (residentes.estado='A' or residentes.estado='E') and residentes.tipodocumento='T.I'";	
...
$url="consentadol.php?idt=$idresi";
$url2="consentadolf.php?idt=$idresi";;
?>
<tr>
<td><?php echo $nomresidente; ?></td>
<td><?php echo $docresidente; ?></td>
<td><?php echo $eps; ?></td>
<td><a href="<?php echo $url; ?>" target="blank">Firmado</a></td>
<td><a href="<?php echo $url2; ?>" target="blank">Para Firmar</a></td>
</tr>
<?php
}
?>
