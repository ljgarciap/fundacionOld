...
where residentes.estado='I' and residentes.nomfund='CENTRO JOREC' order by nomr asc");
...
<td><a href='detalleretj.php?idresidente=<?php echo "$idr"; ?>' target="blank">Retiros</a></td>
