...
$query1="select idusuarios,nombres as nombreesp,apellidos as apelesp from usuarios where documento='$usuariosess'";
$result1=mysqli_query($con,"$query1");
while ($resultx1 = mysqli_fetch_array($result1)) {
$usuarioa=$resultx1['idusuarios'];
$nombreesp=$resultx1['nombreesp'];
$apelesp=$resultx1['apelesp'];
}
