...
<form id="residente" action = "acudientea.php" method = "post">
<div class="row">
<div class="col-md-4">
...
<div class="col-md-4">
Valor uniforme: <input type="number" id="uniforme" name="uniforme"></input>
</div>
</div>
<br>
...
<div class="col-md-6">
<label>Nombres:</label>
<input type="text" id="nombresr" name="nombresr" class="form-control input-sm chat-input" placeholder="Ingrese los nombres del nuevo residente" style="text-transform: uppercase;" required></input></div>
<div class="col-md-6">
<label>Apellidos:</label>
<input type="text" id="apellidosr" name="apellidosr" class="form-control input-sm chat-input" placeholder="Ingrese los apellidos del nuevo residente" style="text-transform: uppercase;" required></input>
</div>
</div>
<br>
...
<input type="number" id="documentor" name="documentor" class="form-control input-sm chat-input" placeholder="Ingrese el documento" required></input>
</div>
</div>
<br>
