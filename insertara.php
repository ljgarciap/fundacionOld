...
<div class="container">
<div class="jumbotron">
<form id="movimiento" action = "movimientoa.php" method = "post">
<br>
<p>
<div class="row">
...
$url="editarasiento.php?idt=$tab&idm=$idtabla&idas=$idasientos";
?>
...
<?php
while ($resultxa3 = mysqli_fetch_array($resulta2)) {
	$tabla="Jorec";
