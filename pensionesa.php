...
$result1=mysqli_query($con,"select idcobrospension,diacobro,valorcobro,nombresr,apellidosr,estado,nomfund from cobrospension join residentes on cobrospension.idresidentes=residentes.idresidentes where residentes.estado='A'");
$ordinal=0;
...
<option value="labonospensiona.php?id=<?php echo $idcobrospension; ?>">Ver abonos</option> 
<option value="abonospensiona.php?id=<?php echo $idcobrospension; ?>">Realizar abono</option>
</select>
</td>
<!-- <form></form> -->
</tr>
