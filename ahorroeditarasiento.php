...
<div class="jumbotron">
<?php
$query="select * from $tablax join asientosahorro on $tablax.idasientosahorro=asientosahorro.idasientosahorro where id$tablax='$idtabla'";
...
?>
<form id="ahorroactmovimiento" action = "ahorroactmovimiento.php" method = "post">
<br>
<p>
<div class="row">
