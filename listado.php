...
$result1=mysqli_query($con,"select residentes.idresidentes as idr, residentes.tipodocumento as tipor, residentes.documentor as cedr, residentes.nombresr as nomr, residentes.apellidosr as apelr, residentes.eps as eps, residentes.nomfund as nomfund, residentes.estado as estado, asociacion.idasociacion as idas, asociacion.parentesco as parent, usuarios.idusuarios as idu, usuarios.documento as docu, usuarios.nombres as nomu, usuarios.apellidos as apelu, usuarios.telefono as telefono, usuarios.email as email from residentes join asociacion on asociacion.idresidentes = residentes.idresidentes join usuarios on asociacion.idusuarios = usuarios.idusuarios 
...
$urlfr="firmac.php?idr=$idr&cedula=$cedr";
$urlfu="firmac.php?idr=$idu&cedula=$docu";
...
<option value="<?php echo "$urlfr"; ?>">Firma residente</option>
<option value="<?php echo "$urlfu"; ?>">Firma acudiente</option>
<option value="<?php echo "$urlestado"; ?>">Desactivar</option>
</select>
</td>
</tr>
<?php
