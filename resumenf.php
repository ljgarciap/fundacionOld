...
<?php
$acump=0;	
$result1=mysqli_query($con,"select asientos.idasientos as idasientos,roca.idroca as idtabla,fecha,concepto,detalle,valorentrada,valorsalida,acumulado from asientos join roca on asientos.idasientos=roca.idasientos order by fecha asc, idroca asc;");
...
$url="editarasiento.php?idt=roca&idm=$idtabla&idas=$idm";
?>
<tr>
