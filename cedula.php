...
<div class="container">
<div class="jumbotron">
	<center><h2>Subir Cédula</h2></center>
	<center><p>Por favor escoja el archivo de cédula a cargar correspondiente al número desde su carpeta de cédulas.</p></center>
        <form action="subircedula.php" method="POST" enctype="multipart/form-data">
