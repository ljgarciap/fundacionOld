...
residentes.documentor,residentes.expedicionr,residentes.tipodocumento,residentes.eps from residentes where residentes.estado='A' or residentes.estado='E'";	
...
$url="resuingresop.php?idt=$idresi";
$url2="docingresop.php?idt=$idresi";
?>
<tr>
<td><?php echo $nomresidente; ?></td>
<td><?php echo $docresidente; ?></td>
<td><?php echo $eps; ?></td>
<td><a href="<?php echo $url; ?>" target="blank">Historia</a></td>
<td><a href="<?php echo $url2; ?>" target="blank">Ingreso</a></td>
</tr>
<?php
}
?>
