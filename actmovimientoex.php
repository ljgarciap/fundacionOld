...
$query="update asientosex set fecha='$fecha',concepto='$concepto',detalle='$nombre',idtipologia='$tipologia' 
where idasientosex='$idas'";
$result=mysqli_query($con,"$query");

$query1="select id$tablax as idt from $tablax where idasientosex=$idas;";
