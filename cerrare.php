...
$sqla="INSERT into tienda (fecha,valorentrada,valorsalida,idresidentes) values ('$hoy','$totalimporte','$totalimporte','$idresidentes')";	
...
header("Location:cerradoe.php?idfacturas=$idfacturas");
?>