...
$query1="INSERT INTO historiaclinicaamp(motivoconsulta,descripcion,amedicos,afamiliares,
	apersonales,condiciones,aspectos,tipologia,observaciones,personal,social,educativa,
	afectiva,estrategias,observacionesgen,impresion,plan,orientador,cedorientador,
	idresidentes) VALUES ('$motivoconsulta','$descripcion','$amedicos','$afamiliares',
	'$apersonales','$condiciones','$aspectos','$tipologia','$observaciones','$personal',
	'$social','$educativa','$afectiva','$estrategias','$observacionesgen','$impresion',
	'$plan','$orientador','$cedorientador','$idresidentes')";
