...
$pdf->Ln(20);
$pdf->Cell(30);
$pdf->Cell(0,15,utf8_decode('CENTRO JOVENES RESTAURADOS EN CRISTO'));
$pdf->Ln(20);
$pdf->SetFont('Arial','',12);
...
La Junta Directiva del CENTRO JOVENES RESTAURADOS EN CRISTO pide a los padres y/o acudientes legales para poder publicar (o negar su publicación), las imágenes en las cuales aparezcan individualmente o en grupo en el desarrollo de su tratamiento y que se puedan realizar a los jóvenes por parte de la Fundación en las diferentes actividades realizadas en la Institución y fuera de la misma.';
$pdf->Write(5,utf8_decode($html2),'');
$pdf->Ln(10);
$pdf->SetFont('Arial','',11);
$pdf->Cell(110,10,utf8_decode('-------------------------------------------------------------------------------------------------------------------------------------------------------------------------'));
$pdf->Ln(10);
$html3="Yo, $nombreu $apellidou con CC: $docu de $expedidou Padre o Acudiente del Residente $nombrer $apellidosr del CENTRO JOVENES RESTAURADOS EN CRISTO.";
$pdf->Write(5,utf8_decode($html3),'');
$pdf->Ln(10);
$html4="$autorizacion doy mi consentimiento para que mi hijo aparezca en las fotografías y/o videos que se publiquen en la página Web, y redes sociales como: Facebook, whatsapp e Instagram del CENTRO JOVENES RESTAURADOS EN CRISTO de forma individual o de grupo, durante la realización de actividades.";
...
$pdf->Ln(20);
$pdf->SetFont('Arial','',11);
$html6="Yo $nombreu $apellidou, identificado(a) con la cédula de ciudadanía No. $docu expedida en $expedidou, manifiesto por medio de este documento que he recibido del CENTRO JOVENES RESTAURADOS EN CRISTO la información acerca del uso de mis datos personales, los cuales serán utilizados dentro del objeto social del CENTRO JOVENES RESTAURADOS EN CRISTO para los fines pertinentes por los cuales fue tomada la correspondiente información, así mismo manifiesto que me fue informado que mis datos personales serán usados por el CENTRO JOVENES RESTAURADOS EN CRISTO, única y exclusivamente para mantenerme informado(a) sobre actividades institucionales, realizar promoción de servicios y eventos de la Institución, para el cumplimiento de obligaciones contractuales; por consiguiente manifiesto que otorgo autorización PREVIA, EXPLICITA, INEQUÍVOCA e INFORMADA al CENTRO JOVENES RESTAURADOS EN CRISTO, para el uso de mis datos personales, para los fines descritos anteriormente los cuales a partir del momento de la firma de la presente autorización, hará parte de la base de datos del CENTRO JOVENES RESTAURADOS EN CRISTO que tiene de sus residentes y demás personas relacionadas con la Institución.
...
2.	Recibir información acerca del uso que el CENTRO JOVENES RESTAURADOS EN CRISTO le da a mis datos personales.
3.	Solicitar una relación detallada acerca de mis datos personales registrados en la base de datos de la Institución.
4.	Autorizar al CENTRO JOVENES RESTAURADOS EN CRISTO a suministrar mis datos personales únicamente a aquellas personas o empresas que la Ley o el suscrito determinen.
...
$pdf->Ln(20);
$pdf->SetFont('Arial','',11);
$html7="Yo $nombrer $apellidosr, identificado(a) con $tipodr No. $cedular expedida en $expedidor, manifiesto por medio de este documento que he recibido del CENTRO JOVENES RESTAURADOS EN CRISTO la información acerca del uso de mis datos personales, los cuales serán utilizados dentro del objeto social del CENTRO JOVENES RESTAURADOS EN CRISTO para los fines pertinentes por los cuales fue tomada la correspondiente información, así mismo manifiesto que me fue informado que mis datos personales serán usados por el CENTRO JOVENES RESTAURADOS EN CRISTO, única y exclusivamente para mantenerme informado(a) sobre actividades institucionales, realizar promoción de servicios y eventos de la Institución, para el cumplimiento de obligaciones contractuales; por consiguiente manifiesto que otorgo autorización PREVIA, EXPLICITA, INEQUÍVOCA e INFORMADA al CENTRO JOVENES RESTAURADOS EN CRISTO, para el uso de mis datos personales, para los fines descritos anteriormente los cuales a partir del momento de la firma de la presente autorización, hará parte de la base de datos del CENTRO JOVENES RESTAURADOS EN CRISTO que tiene de sus residentes y demás personas relacionadas con la Institución.
...
$pdf->Ln(7);
$pdf->Cell(30);
$pdf->Cell(0,5,utf8_decode('1. DECLARACIÓN DEL CENTRO JOVENES RESTAURADOS EN CRISTO'));
$pdf->Ln(7);
...
$pdf->Ln(10);
$pdf->MultiCell(196,5,utf8_decode('a. Declaro en el presente documento que exonero al CENTRO JOVENES RESTAURADOS EN CRISTO de responsabilidades penales o civiles.
...
c. Que el CENTRO JOVENES RESTAURADOS EN CRISTO no se hará responsable de mis fugas y de lo que posiblemente pueda ocasionarme dicha fuga. 
d. Que el CENTRO JOVENES RESTAURADOS EN CRISTO no se hará responsable de un posible suicidio dentro o fuera de la institución.  
e. El CENTRO JOVENES RESTAURADOS EN CRISTO no responderá por jóvenes que por su cuadro clínico presente síntomas de depresión o sufran de esta enfermedad y atenten contra su vida.
f. El CENTRO JOVENES RESTAURADOS EN CRISTO no responderá por objetos de valor   de jóvenes que se ausenten da la fundación las prendas dejadas tales como ropa útiles de aseo y de más pertenencia la familia tendrá un plazo máximo de ocho días para buscar dichas pertenencias si no lo hace en este lapso de tiempo la fundación no se hará responsable de dichas pertenencias 
g. La colchoneta que ingresa a la fundación quedará donada al CENTRO JOVENES RESTAURADOS EN CRISTO.
