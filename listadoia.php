...
$result1=mysqli_query($con,"select residentes.idresidentes as idr, residentes.tipodocumento as tipor, residentes.documentor as cedr, residentes.nombresr as nomr, residentes.apellidosr as apelr, residentes.nomfund as nomfund, asociacion.idasociacion as idas, historiali.fecharetiro as fecharetiro, historiali.idhistoriali as idhistoriali, historiali.motivo as motivor from residentes join asociacion on asociacion.idresidentes = residentes.idresidentes join historiali on historiali.idresidentes=residentes.idresidentes join usuarios on asociacion.idusuarios = usuarios.idusuarios 
where residentes.estado='I' order by nomr asc");
