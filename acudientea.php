...
$residentes="INSERT INTO residentes(documentor,expedicionr,fechanacimiento,nombresr,apellidosr,telefono,
celular,profesion,email,estado,direccionf,ciudad,estudios,estadocivil,conyuge,
tipodocumento,eps,padre,madre,nomfund) VALUES ('$documentor','$expedicion','$fechan',
'$nombresr','$apellidosr','$telefonor','$celularr','$profesion','$emailr','A',
'$direccion','$ciudad','$estudios','$estadocivil','$conyuge','$tipodocr','$seguro',
'$padre','$madre','$nomfund')";
...
<form id="acudiente" action = "registroa.php" method = "post">
<p>

<div class="row">
<div class="col-md-6">
<label>Nombres:</label>
<input type="text" id="nombresa" name="nombresa" class="form-control input-sm chat-input" placeholder="Ingrese los nombres del acudiente" style="text-transform: uppercase;"></input></div>
<div class="col-md-6">
<label>Apellidos:</label>
<input type="text" id="apellidosa" name="apellidosa" class="form-control input-sm chat-input" placeholder="Ingrese los apellidos del acudiente" style="text-transform: uppercase;"></input>
</div>
</div>
<br>
...
<input type="number" id="documentoa" name="documentoa" class="form-control input-sm chat-input" placeholder="Ingrese el documento"></input>
</div>
<div class="col-md-4">
...
<input type="number" id="celulara" name="celulara" class="form-control input-sm chat-input" placeholder="Ingrese el número de celular o fijo"></input>
</div>
</div>
<br>
