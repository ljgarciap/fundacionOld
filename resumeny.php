...
$acump=0;	
$result1=mysqli_query($con,"select asientos.idasientos as idasientos,yuly.idyuly as idtabla,fecha,concepto,detalle,valorentrada,valorsalida,acumulado from asientos join yuly on asientos.idasientos=yuly.idasientos order by fecha asc, idyuly asc;");
...
if($acum==$acump){$url="editarasiento.php?idt=yuly&idm=$idtabla&idas=$idm";}
else{$url="editarasiento.php?idt=yuly&idm=$idtabla&idas=$idm";
$query1="update yuly set acumulado='$acump' where yuly.idasientos='$idm'";
