...
?>
<tr>
<form id="pago" action = "pagouniformesb.php" method = "post">
...
<option value="labonosub.php?id=<?php echo $iduniformes; ?>">Ver abonos</option> 
<option value="abonosub.php?id=<?php echo $iduniformes; ?>">Realizar abono</option>
</select>
</td>
</tr>
<?php
