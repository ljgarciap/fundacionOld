...
$result1=mysqli_query($con,"select agenda.idagenda as idagenda, agenda.fecha as fecha, agenda.hora as hora, agenda.estado as estado, agenda.idresidentes as idresidentes, residentes.nombresr as nombres, residentes.apellidosr as apellidos from agenda join residentes on agenda.idresidentes=residentes.idresidentes where agenda.encargado='PSICOLOGA' and agenda.estado='E' order by hora asc;");
...
?>
<tr>
<form id="pago" action = "cierreagp.php" method = "post">
