...
$query1="select acumulado from colombia order by fecha DESC,idcolombia DESC LIMIT 1;";
...
$query2="INSERT INTO colombia(fecha,concepto,valorentrada,valorsalida,acumulado) 
